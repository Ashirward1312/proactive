...
export default function BackNeckPain() {
  ...
  const treatments = [
    ...
    "Slip Disc & Sciatica Recovery",
    "Postural Correction & Ergonomics",
    "Scoliosis Management",
    "Stiff Neck & Tension Headaches",
  ...
  const processSteps = [
    {
      ...
      desc: "Clinical assessment of alignment, mobility and nerve sensitivity.",
      icon: <Search className="w-5 h-5" />,
      chip: "bg-blue-600",
    },
    {
      title: "Recovery Roadmap",
      desc: "Step-by-step plan to reduce pain and rebuild core stability.",
      icon: <FileText className="w-5 h-5" />,
      chip: "bg-[#C1121F]",
    },
    {
      title: "Hands-on Reset",
      desc: "Manual therapy to decompress and restore natural movement.",
      icon: <ActivityIcon className="w-5 h-5" />,
      chip: "bg-emerald-600",
    },
    {
      title: "Postural Stability",
      desc: "Ergonomics + strength work for long-term pain-free living.",
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            >
              ...
              >
                Heal your <span className="text-[#C1121F]">back</span> &{" "}
                <span className="text-[#FACC15]">neck</span> — properly.
              </motion.h1>
              ...
              >
                Pain shouldn’t control your day. We improve mobility, reduce nerve
                irritation and correct posture with targeted physiotherapy.
              </motion.p>
              ...
              <motion.div variants={itemUp} className="mt-7 flex flex-wrap gap-3">
                ...
                >
                  <span className="relative z-10 inline-flex items-center gap-2">
                    Get Relief Now <ArrowRight className="w-5 h-5" />
                  </span>
            ...
            >
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-[0_40px_90px_-25px_rgba(15,23,42,0.35)] border-8 border-white bg-white">
                <div className="relative aspect-[16/12]">
                  <img src={Back} alt="Spinal Relief" className="w-full h-full object-cover" />
              ...
              >
                <div className="flex items-center gap-3">
                  <ActivityIcon className="w-6 h-6 text-[#C1121F]" />
                  <div>
                    <div className="font-['Poppins'] font-bold text-white text-lg">95%</div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h2 className="mt-3 font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-[#0F172A] leading-tight">
              Road to spinal <span className="text-[#C1121F]">freedom</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            >
              <div className="rounded-[2.5rem] overflow-hidden shadow-xl border-8 border-white bg-white">
                <div className="relative aspect-[16/12]">
                  <img src={Neck} alt="Neck Pain Relief" className="w-full h-full object-cover" />
            ...
            >
              <h2 className="font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-[#0F172A] leading-tight">
                Precision care <br />
                <span className="text-[#C1121F]">for real relief.</span>
              </h2>

              <p className="mt-4 text-sm sm:text-base leading-relaxed text-slate-600">
                We combine manual therapy, movement retraining, and ergonomics to reduce pain
                and build long-term spinal stability.
              </p>
              ...
              <div className="mt-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-5 bg-[#F8FAFC] rounded-3xl border border-slate-100">
                  ...
                  <p className="mt-1 text-sm text-slate-600">Nerve decompression + pain calming techniques.</p>
                </div>

                <div className="p-5 bg-[#F8FAFC] rounded-3xl border border-slate-100">
                  <ActivityIcon className="w-8 h-8 text-[#C1121F] mb-3" />
                  <h4 className="font-['Poppins'] text-base font-bold text-[#0F172A]">Mobility</h4>
                  <p className="mt-1 text-sm text-slate-600">Flexibility + strength work for daily comfort.</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            <h2 className="font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-[#0F172A]">
              Conditions we <span className="text-[#C1121F]">solve</span>
            </h2>
            <div className="mt-4 w-20 h-1.5 bg-[#FACC15] mx-auto rounded-full" />
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-tight">
              Live pain <span className="text-[#C1121F]">free</span>.
            </h2>

            <p className="mt-4 text-sm sm:text-base text-slate-300 max-w-2xl mx-auto leading-relaxed">
              Don’t wait for spinal pain to get worse. Start your journey to a healthier spine today.
            </p>
