...
export default function ExercisePhysiology() {
  ...
  const processSteps = [
    {
      ...
      desc: "Baseline testing of aerobic capacity, strength and movement quality.",
      icon: <Search className="w-5 h-5" />,
      chip: "bg-blue-600",
    },
    {
      title: "Science-Backed Plan",
      desc: "Exercise prescription based on your clinical needs and goals.",
      icon: <FileText className="w-5 h-5" />,
      chip: "bg-[#C1121F]",
    },
    {
      title: "Guided Training",
      desc: "Supervised sessions with proper technique and intensity control.",
      icon: <Activity className="w-5 h-5" />,
      chip: "bg-emerald-600",
    },
    {
      title: "Metric Tracking",
      desc: "Monitor progress with clear numbers and milestone targets.",
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            >
              ...
              >
                Exercise Physiology, <br className="hidden sm:block" />
                <span className="text-[#C1121F]">done clinically.</span>
              </motion.h1>
              ...
              >
                Move with purpose. Our programs combine clinical science and coaching to improve
                health markers, build strength and manage chronic conditions.
              </motion.p>
            ...
            >
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-[0_40px_90px_-25px_rgba(15,23,42,0.35)] border-8 border-white bg-white">
                <div className="relative aspect-[16/12]">
                  <img src={ExerciseImg1} alt="Exercise Science" className="w-full h-full object-cover" />
              ...
              >
                <div className="flex items-center gap-3">
                  <HeartPulse className="w-6 h-6 text-[#C1121F]" />
                  <div>
                    <div className="font-['Poppins'] font-bold text-white text-lg">Clinical</div>
                    <p className="text-[10px] text-slate-400 uppercase tracking-widest">Performance</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h2 className="mt-3 font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-[#0F172A] leading-tight">
              Movement science, <span className="text-[#C1121F]">step-by-step</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            >
              <div className="rounded-[2.5rem] overflow-hidden shadow-xl border-8 border-white bg-white">
                <div className="relative aspect-[16/12]">
                  <img src={ExerciseImg2} alt="Science Training" className="w-full h-full object-cover" />
            ...
            >
              <h2 className="font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-[#0F172A] leading-tight">
                Movement as <br />
                <span className="text-[#C1121F]">clinical medicine.</span>
              </h2>

              <p className="mt-4 text-sm sm:text-base leading-relaxed text-slate-600">
                This is not random workouts. It’s a structured plan built from testing, medical context,
                and measurable progression—so you improve safely and consistently.
              </p>

              <div className="mt-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-5 bg-[#F8FAFC] rounded-3xl border border-slate-100">
                  <Timer className="w-8 h-8 text-[#FACC15] mb-3" />
                  <h4 className="font-['Poppins'] text-base font-bold text-[#0F172A]">Metrics</h4>
                  <p className="mt-1 text-sm text-slate-600">Track progress with clear, simple numbers.</p>
                </div>

                <div className="p-5 bg-[#F8FAFC] rounded-3xl border border-slate-100">
                  <Dumbbell className="w-8 h-8 text-[#C1121F] mb-3" />
                  <h4 className="font-['Poppins'] text-base font-bold text-[#0F172A]">Strength</h4>
                  <p className="mt-1 text-sm text-slate-600">Build capacity for daily life and sport.</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            <h2 className="font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-[#0F172A]">
              Areas of <span className="text-[#C1121F]">focus</span>
            </h2>
            <div className="mt-4 w-20 h-1.5 bg-[#FACC15] mx-auto rounded-full" />
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="font-['Poppins'] text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-tight">
              Unlock your <span className="text-[#C1121F]">potential</span>.
            </h2>

            <p className="mt-4 text-sm sm:text-base text-slate-300 max-w-2xl mx-auto leading-relaxed">
              Whether you’re managing a condition or building performance, we’ll guide your progression safely.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Talk to Physiologist <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
          </div>
        </motion.div>
